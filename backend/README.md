...
## Project Structure
    ...
    ├── testapiautoteammemb_56514  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_56514`
...
2. Clone this repo and `cd testapiautoteammemb_56514`
